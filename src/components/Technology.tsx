...
export function Technology() {
  ...
  return (
    <section id="technology" className="py-24 bg-gradient-to-br from-background/50 to-background">
          ...
          <Card className="max-w-4xl mx-auto bg-gradient-to-r from-blue-500/5 to-purple-500/5 border-blue-500/20">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Our team stays at the forefront of technology trends, continuously learning and adapting to ensure 
